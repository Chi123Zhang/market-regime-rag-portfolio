...
st.sidebar.info(
    "This demo uses the improved feature-space balanced KNN classifier from "
    "`regime_inference.py`, not the original TF-IDF majority-vote baseline."
)
...
└── Output regime + confidence + portfolio rationale
...
└── Equity curve / drawdown / metrics output
    ...
    st.write(
        ...
        "The improved version uses numeric market features and class-balanced KNN to make "
        "the classifier more sensitive to rare but important states such as bear markets, "
        "high-volatility regimes, and risk-off environments."
    )
